    ...
    if (!appliedMigrations.has(migration.name)) {
      ...
      try {
        ...
        const isDuplicateColumnError =
          ...
          message.includes('duplicate column name: change_id') ||
          message.includes('duplicate column name: change_task_ref') ||
          message.includes('duplicate column name: phase_id');
        const isKnownLocalPrColumnMigration =
          ...
          migration.name === '064_supervisor_changes_v1';
