...
interface LaunchProviderRunInput {
  ...
  modeValue: string;
  permissionCallback: (request: import('@my-claudia/shared/interaction/permissions').PermissionRequest) => Promise<import('../../../infrastructure/providers/claude-sdk.js').PermissionDecision>;
