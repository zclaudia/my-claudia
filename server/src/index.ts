...
import { setGatewayClient } from './domains/gateway/gateway-instance.js';
...
import { EmbeddedBackendFacadeProvider } from './domains/gateway/embedded-provider.js';
import { StandaloneBackendFacadeProvider } from './domains/gateway/standalone-provider.js';
import type { LocalBackendHandler } from './domains/gateway/embedded-adapter.js';
import type { SessionCatalogItem } from '@my-claudia/shared';
import { hasForegroundActiveRunForSession } from './utils/run-state.js';
import type { FacadeWsHub } from './domains/gateway/ws-hub.js';
